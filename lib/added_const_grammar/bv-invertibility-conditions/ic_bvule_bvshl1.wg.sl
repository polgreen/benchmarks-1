...
(synth-fun SC ((s (_ BitVec 4)) (t (_ BitVec 4))) Bool
    ...
    (StartBv (_ BitVec 4) (s t #x0 #x1 (Constant (_ BitVec 4)) (bvneg StartBv) (bvnot StartBv) (bvadd StartBv StartBv) (bvsub StartBv StartBv) (bvand StartBv StartBv) (bvlshr StartBv StartBv) (bvor StartBv StartBv) (bvshl StartBv StartBv)))))
