...
(synth-fun move ((currPoint Int) (o0 Int) (o1 Int)) Int
    ...
    (MoveId Int (0 1 (Constant Int)))
    (CondInt Int ((get-y currPoint) (get-x currPoint) (get-y o0) (get-x o0) (get-y o1) (get-x o1) (+ CondInt CondInt) (- CondInt CondInt) (- 1) 0 1 (Constant Int)))
