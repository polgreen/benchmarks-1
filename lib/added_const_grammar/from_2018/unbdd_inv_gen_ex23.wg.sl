...
(declare-var z1 Int)
(declare-var c1 Int)
(constraint (implies (and (= c 0) (< 127 y)) true))
(constraint (implies (and3 (= c 0) (>= 127 y) (< y 0)) true))
(constraint (implies (and4 (= c 0) (>= 127 y) (>= y 0) (= z (* y 36))) (inv y z c)))
(constraint (implies (and5 (inv y z c) (< c 36) (not (or (< z 0) (>= z 4608))) (= z1 (+ z 1)) (= c1 (+ c 1))) (inv y z1 c1)))
(constraint (implies (and3 (inv y z c) (< c 36) (or (< z 0) (>= z 4608))) false))
